 ...
 */
final class Version20251107150634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_D72F30DDFD07C8FB ON language_translation (is_deleted)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D72F30DD8A90ABA9A7A91E0B82F1BAF4 ON language_translation (key, domain, language_id)');
        ...
        $this->addSql('ALTER TABLE language_translation ADD CONSTRAINT FK_D72F30DD82F1BAF4 FOREIGN KEY (language_id) REFERENCES language (id) ON DELETE CASCADE NOT DEFERRABLE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE language_translation DROP CONSTRAINT FK_D72F30DD82F1BAF4');
