...
<template>
	<div class="min-h-screen bg-gray-50 relative px-4 sm:px-6 lg:px-8">
		<div
			class="absolute top-8 left-1/2 transform -translate-x-1/2 md:left-4 md:transform-none md:translate-x-0 lg:left-8"
		>
			...
			<div class="max-w-md w-full space-y-8">
				...
				<form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
					...
					<div class="text-right -mt-3">
						<a
							:href="`/${shortCode}/user/forgot-password`"
